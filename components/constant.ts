...
export const COMPETITION_HIGHLIGHTS = [
  ...
  },
  {
    ...
    description:
      "Opportunity to push yourself to work with open data provided by DOSM such as OpenDOSM, eStatistik, and etc.",
...
export const OFFICIAL_SPONSORS: Sponsor[] = [
  {
    name: "Statworks",
    logo: "/assets/sponsor/LOGO STATSWORK.png",
    logoAlt: "Statworks",
    width: 180,
    height: 80,
    className: "w-36 h-20 md:w-44 md:h-24 bg-white p-4 object-contain",
    tier: "platinum",
    description:
      "Statworks Solution Services offers a range of excellent services in consulting, technical support and education that will provide further value to our customers and which can grow and adapt with our clients’ needs in tomorrow´s technology.",
    website: "https://www.statwks.com/",
    industry: "Education Technology",
    founded: "2019",
    headquarters: "Petaling Jaya, Selangor, Malaysia",
  },
  {
    name: "GIBS Eco Tourism Resort",
    logo: "/assets/sponsor/LOGO GIBS RESORT.png",
    logoAlt: "GIBS Eco Tourism Resort",
    width: 180,
    height: 80,
    className: "w-36 h-20 md:w-44 md:h-24 bg-white object-contain",
    tier: "silver",
    description:
      "GIBS Eco Tourism Resort is a premier eco-tourism destination in Malaysia, offering sustainable travel experiences that connect visitors with nature. We are committed to environmental conservation and community engagement, making us a leader in eco-friendly tourism.",
    website: "https://www.gibs.org.my/page6.html",
    industry: "Hospitality & Tourism",
    founded: "2016",
    headquarters: "Batu Cave, Selangor, Malaysia",
  },
  {
    name: "Evopoint Sdn. Bhd.",
    logo: "/assets/sponsor/LOGO MICROSOFT EVO.png",
    logoAlt: "Evopoint Sdn. Bhd.",
    width: 240,
    height: 90,
    className: "w-36 h-20 md:w-44 md:h-24 px-4 bg-white object-contain",
    tier: "bronze",
    description:
      "Evopoint sdn. Bhd. are Microsoft Managed Partner with more than 10 years of experience in helping organizations with their digital transformation journey, as well as modernize business security, and upgrade from traditional antivirus software to enterprise-grade security for organization's app, identity, data, and device.",
    website: "https://www.evo-point.com/",
    industry: "Technology & Software",
    headquarters: "Puchong, Selangor, Malaysia",
  },

  {
    name: "Institusi Statistik Malaysia",
    logo: "/assets/sponsor/LOGO ISMy.jpg",
    logoAlt: "Institusi Statistik Malaysia",
    width: 180,
    height: 80,
    className: "w-36 h-20 md:w-44 md:h-24 bg-white object-contain",
    tier: "bronze",
    ...
    website: "https://www.instatmalaysia.com/",
    industry: "non-profit making body",
    founded: "1981",
  },
  {
    name: "Persatuan Sains Matematik Malaysia",
    logo: "/assets/sponsor/LOGO PERSAMA.png",
    logoAlt: "Persatuan Sains Matematik Malaysia",
    width: 180,
    height: 80,
    className: "w-36 h-20 md:w-44 md:h-24 bg-white py-2 object-contain",
    tier: "bronze",
    description:
      "Persatuan Sains Matematik Malaysia (PERSAMA) is a professional organization dedicated to promoting the advancement of mathematical sciences in Malaysia. It serves as a platform for collaboration among educators, researchers, and practitioners, fostering research, education, and the application of mathematics across various fields. PERSAMA also represents Malaysia in international mathematical communities and plays a key role in nurturing interest and excellence in mathematics nationwide.",
    website: "https://www.persama.org.my",
...
export const MEDIA_PARTNERS: MediaPartner[] = [
  {
    ...
    logo: "/assets/media-partner/APUACTURIALSCIENCE CLUB.jpg",
    logoAlt: "Media Partner 1",
    width: 160,
    height: 80,
    className: "w-32 h-20 md:w-40 md:h-24 bg-white py-2 object-contain",
  },
  {
    name: "Media Partner 2",
    logo: "/assets/media-partner/BASCO (Bachelor of Computer Science), Uitm Tapahbcsuitmtapah.jpg",
  ...
  },
  {
    ...
    logo: "/assets/media-partner/COMOBISTA_1.png",
  ...
  },
  {
    ...
    logo: "/assets/media-partner/CSOfficialLogo.png",
  ...
  {
    name: "Media Partner 1",
    logo: "/assets/media-partner/DEGREE MATHEMATICS SOCIETY.png",
    logoAlt: "Media Partner 1",
    width: 160,
    height: 160,
    className: "w-32 h-20 md:w-40 md:h-24 bg-white p-2 object-contain",
  },
  {
    name: "Media Partner 2",
    logo: "/assets/media-partner/FORENSICSECURITYRESEARCH CENTER.jpg",
    logoAlt: "Media Partner 2",
    width: 160,
    height: 80,
    className: "w-32 h-20 md:w-40 md:h-24 bg-white py-2 object-contain",
  ...
  {
    name: "Media Partner 3",
    logo: "/assets/media-partner/IMG_20251009_181954_106.jpg",
    logoAlt: "Media Partner 3",
    width: 160,
    height: 80,
    className: "w-32 h-20 md:w-40 md:h-24 bg-black py-2 object-contain",
  },
  {
    name: "Media Partner 4",
    logo: "/assets/media-partner/Itcomm_Uitmck.png",
    logoAlt: "Media Partner 4",
    width: 160,
    height: 80,
    className: "w-32 h-20 md:w-40 md:h-24 bg-white p-2 object-contain",
  ...
  {
    name: "Media Partner 1",
    logo: "/assets/media-partner/LogoRasmiHorizontal.png",
    logoAlt: "Media Partner 1",
    width: 160,
    height: 80,
    className: "w-32 h-20 md:w-40 md:h-24 bg-white py-2 object-contain",
  ...
  {
    name: "Media Partner 2",
    logo: "/assets/media-partner/MathematicClub.png",
    logoAlt: "Media Partner 2",
    width: 160,
    height: 80,
    className: "w-32 h-20 md:w-40 md:h-24 bg-white p-2 object-contain",
  ...
  {
    name: "Media Partner 3",
    logo: "/assets/media-partner/msu_cfc_black_bacground.jpg",

    logoAlt: "Media Partner 3",
    width: 160,
    height: 80,
    className: "w-32 h-20 md:w-40 md:h-24 bg-black p-2 object-contain",
  },
  {
    name: "Media Partner 4",
    logo: "/assets/media-partner/Netcom_Logo.png",
    logoAlt: "Media Partner 4",
    width: 160,
    height: 80,
    className: "w-32 h-20 md:w-40 md:h-24 bg-white p-2 object-contain",
  ...
  {
    name: "Media Partner 1",
    logo: "/assets/media-partner/persistapah.jpg",
    logoAlt: "Media Partner 1",
    width: 160,
    height: 80,
    className: "w-32 h-20 md:w-40 md:h-24 bg-white p-2 object-contain",
  ...
  {
    name: "Media Partner 2",
    logo: "/assets/media-partner/SASCOMM(SerembanActuarialScienceCommitee)@sascomms3.jpg",
    logoAlt: "Media Partner 2",
    width: 160,
    height: 80,
    className: "w-32 h-20 md:w-40 md:h-24 bg-white p-2 object-contain",
  ...
  {
    name: "Media Partner 3",
    logo: "/assets/media-partner/SYNTECHORGANIZATIONUTP.jpg",
    logoAlt: "Media Partner 3",
    width: 160,
    height: 80,
    className: "w-32 h-20 md:w-40 md:h-24 bg-white p-2 object-contain",
  ...
  {
    name: "Media Partner 4",
    logo: "/assets/media-partner/PSK_UPSI.png",
    logoAlt: "Media Partner 4",
    width: 160,
    height: 160,
    className: "w-32 h-20 md:w-40 md:h-24 bg-white p-2 object-contain",
