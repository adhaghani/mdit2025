...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("🎓 Claiming certificate for IC:", icNumber);

    // Call Supabase function to claim certificate
    const { data, error } = await supabase.rpc("claim_certificate", {
      p_ic_number: icNumber,
    });

    console.log("✅ Certificate claim result:", data);
    console.log("❌ Certificate claim error:", error);
